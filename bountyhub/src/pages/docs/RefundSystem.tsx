    ...
    <div className="min-h-screen bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white transition-colors duration-200">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-neutral-900 dark:text-white mb-4">Refund System Guide</h1>
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-lg p-6 mb-8 border border-neutral-200 dark:border-neutral-700">
          ...
          <ul className="space-y-2 text-neutral-600 dark:text-neutral-600 dark:text-gray-300">
            <li><a href="#overview" className="text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300">Overview</a></li>
        ...
        <section id="eligibility" className="mb-12">
          <h2 className="text-3xl font-bold text-neutral-900 dark:text-white mb-6">Eligibility</h2>
          <div className="bg-white dark:bg-neutral-800 rounded-lg p-6 border border-neutral-200 dark:border-neutral-700">
            <ul className="text-neutral-600 dark:text-neutral-600 dark:text-gray-300 space-y-2">
        ...
        <section id="governance" className="mb-12">
          <h2 className="text-3xl font-bold text-neutral-900 dark:text-white mb-6">Governance & Voting</h2>
          <div className="bg-white dark:bg-neutral-800 rounded-lg p-6 border border-neutral-200 dark:border-neutral-700">
            <ul className="text-neutral-600 dark:text-neutral-600 dark:text-gray-300 space-y-2">
        ...
        <section id="timelocks" className="mb-12">
          <h2 className="text-3xl font-bold text-neutral-900 dark:text-white mb-6">Time-based Restrictions</h2>
          <div className="bg-white dark:bg-neutral-800 rounded-lg p-6 border border-neutral-200 dark:border-neutral-700">
            <ul className="text-neutral-600 dark:text-neutral-600 dark:text-gray-300 space-y-2">
        ...
        <section id="faq" className="mb-12">
          ...
          <div className="space-y-6">
            <div className="bg-neutral-800 rounded-lg p-6">
              ...
              <p className="text-neutral-600 dark:text-gray-300">Refunds are only available for unresolved or unsatisfactory bounties and must meet eligibility criteria.</p>
            </div>
            <div className="bg-neutral-800 rounded-lg p-6">
              <h3 className="text-xl font-semibold text-white mb-3">How long does the refund process take?</h3>
              <p className="text-neutral-600 dark:text-gray-300">The process typically takes 2-3 days, depending on community voting and review.</p>
            </div>
            <div className="bg-neutral-800 rounded-lg p-6">
              <h3 className="text-xl font-semibold text-white mb-3">What happens if my refund is denied?</h3>
              <p className="text-neutral-600 dark:text-gray-300">If denied, the bounty remains locked or is distributed according to platform rules.</p>
            </div>
            <div className="bg-neutral-800 rounded-lg p-6">
              <h3 className="text-xl font-semibold text-white mb-3">Can I appeal a refund decision?</h3>
              <p className="text-neutral-600 dark:text-gray-300">Appeals may be submitted for review by platform moderators in exceptional cases.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-neutral-600 dark:text-gray-400 text-sm">Complete user guide and tutorials</p>
            </Link>
            <Link
              to="/docs/platform"
              className="block p-6 bg-neutral-800 rounded-lg border border-neutral-700 hover:border-violet-500/40 transition-all duration-300"
            >
              ...
              <p className="text-neutral-600 dark:text-gray-400 text-sm">Platform overview and features</p>
            </Link>
            <Link
              to="/docs/legal"
              className="block p-6 bg-neutral-800 rounded-lg border border-neutral-700 hover:border-violet-500/40 transition-all duration-300"
            >
              ...
              <p className="text-neutral-600 dark:text-gray-400 text-sm">Terms, privacy, and compliance</p>
            </Link>
            <Link
