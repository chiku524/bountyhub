      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-neutral-800 rounded-lg p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            <li><a href="#overview" className="text-violet-400 hover:text-violet-300">API Overview</a></li>
        ...
        <section id="overview" className="mb-12">
          ...
          <div className="bg-neutral-800 rounded-lg p-6">
            ...
            <div className="bg-neutral-700 rounded-lg p-4 font-mono text-sm">
              ...
              <div className="text-gray-300">https://api.bountyhub.tech</div>
              <div className="text-violet-400 mt-2">Development:</div>
              <div className="text-gray-300">http://localhost:8787</div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="bg-neutral-700 rounded-lg p-4 font-mono text-sm">
                <div className="text-gray-300">https://api.bountyhub.tech/v1/posts</div>
              </div>
            </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-3">Create a new user account</p>
  ...
  "user": {
    ...
    "email": "user@example.com"
              ...
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-3">Authenticate user and get JWT token</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h5 className="text-white font-semibold mb-2">Request Body</h5>
                    <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-3">Get paginated list of posts</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
  ...
  "post": {
    ...
    "createdAt": "2025-01-01T00:00:00Z"
              ...
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-3">Get a specific post with answers and comments</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-3">Get user's wallet information</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h5 className="text-white font-semibold mb-2">Response</h5>
                    <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
  ...
  "wallet": {
    ...
    "transactions": [...]
              ...
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-3">Initiate BBUX deposit</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h5 className="text-white font-semibold mb-2">Request Body</h5>
                    <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
  ...
  "transaction": {
    ...
    "solAmount": 0.1
              ...
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-3">Withdraw BBUX tokens</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h5 className="text-white font-semibold mb-2">Request Body</h5>
                    <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-3">Get user profile information</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h5 className="text-white font-semibold mb-2">Path Parameters</h5>
                    <ul className="text-gray-400 space-y-1 text-sm">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-3">Get user's notifications with pagination</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h5 className="text-white font-semibold mb-2">Query Parameters</h5>
                    <ul className="text-gray-400 space-y-1 text-sm">
  ...
  "pagination": {
    ...
    "pages": 3
              ...
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-3">Mark a specific notification as read</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h5 className="text-white font-semibold mb-2">Path Parameters</h5>
                    <ul className="text-gray-400 space-y-1 text-sm">
...
{`{
  ...
  "message": "Notification marked as read"
              ...
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-3">Mark all user notifications as read</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h5 className="text-white font-semibold mb-2">Request Body</h5>
                    <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
...
{`{
  ...
  "updatedCount": 15
              ...
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-3">Get the count of unread notifications</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h5 className="text-white font-semibold mb-2">No Parameters</h5>
                    <p className="text-gray-400 text-sm">Returns count of unread notifications</p>
                  </div>
                  <div>
                    <h5 className="text-white font-semibold mb-2">Response</h5>
                    <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
        ...
        <section id="virtual-tokens" className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-neutral-800 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-3">Get user's virtual wallet information</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="text-white font-semibold mb-2">No Parameters</h5>
                  <p className="text-gray-400 text-sm">Returns wallet balance and transaction history</p>
                </div>
                <div>
                  <h5 className="text-white font-semibold mb-2">Response</h5>
                  <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
    ...
    "transactions": [
      {
        ...
        "createdAt": "string (ISO 8601)"
            ...
            <div className="bg-neutral-800 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-3">Get platform statistics including token supply</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="text-white font-semibold mb-2">No Parameters</h5>
                  <p className="text-gray-400 text-sm">Returns platform-wide statistics</p>
                </div>
                <div>
                  <h5 className="text-white font-semibold mb-2">Response</h5>
                  <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
        ...
        <section id="governance" className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-neutral-800 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-3">Get governance dashboard data</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="text-white font-semibold mb-2">No Parameters</h5>
                  <p className="text-gray-400 text-sm">Returns governance metrics and user staking info</p>
                </div>
                <div>
                  <h5 className="text-white font-semibold mb-2">Response</h5>
                  <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
    ...
    "transparencyLogs": [
      {
        ...
        "timestamp": "string (ISO 8601)"
            ...
            <div className="bg-neutral-800 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-3">Stake BBUX tokens for governance participation</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="text-white font-semibold mb-2">Request Body</h5>
                  <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
...
{`{
  ...
  "rewardRate": 0.08
            ...
            <div className="bg-neutral-800 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-3">Unstake BBUX tokens</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="text-white font-semibold mb-2">Request Body</h5>
                  <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
...
{`{
  ...
  "rewardRate": 0.08
            ...
            <div className="bg-neutral-800 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-3">Get current reward rates and platform metrics</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="text-white font-semibold mb-2">No Parameters</h5>
                  <p className="text-gray-400 text-sm">Returns current reward rates and platform health</p>
                </div>
                <div>
                  <h5 className="text-white font-semibold mb-2">Response</h5>
                  <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
        ...
        <section id="refunds" className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-neutral-800 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-3">Get list of refund requests with pagination</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="text-white font-semibold mb-2">Query Parameters</h5>
                  <ul className="text-gray-400 space-y-1 text-sm">
  ...
  "pagination": {
    ...
    "pages": 2
            ...
            <div className="bg-neutral-800 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-3">Create a new refund request</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="text-white font-semibold mb-2">Request Body</h5>
                  <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
  ...
  "refundRequest": {
    ...
    "expiresAt": "string (ISO 8601)"
            ...
            <div className="bg-neutral-800 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-3">Vote on a refund request</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="text-white font-semibold mb-2">Request Body</h5>
                  <pre className="bg-neutral-700 p-3 rounded text-sm text-gray-300">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-gray-400 text-sm">Source code and examples</p>
            </a>
          </div>
        </section>
