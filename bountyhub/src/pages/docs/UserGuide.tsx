      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-neutral-800 rounded-lg p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            <li><a href="#getting-started" className="text-violet-400 hover:text-violet-300">Getting Started</a></li>
            <li><a href="#account-setup" className="text-violet-400 hover:text-violet-300">Account Setup</a></li>
        ...
        <section id="getting-started" className="mb-12">
          ...
          <div className="bg-neutral-800 rounded-lg p-6">
            <h3 className="text-xl font-semibold text-white mb-4">Welcome to bountyhub</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <div className="text-center p-4 bg-neutral-700 rounded-lg">
                <FiUser className="w-8 h-8 text-violet-400 mx-auto mb-2" />
                <h4 className="text-white font-semibold">Create Account</h4>
                <p className="text-gray-400 text-sm">Sign up and verify your account</p>
              </div>
              <div className="text-center p-4 bg-neutral-700 rounded-lg">
                <FiDollarSign className="w-8 h-8 text-violet-400 mx-auto mb-2" />
                <h4 className="text-white font-semibold">Virtual Wallet</h4>
                <p className="text-gray-400 text-sm">Start earning BBUX tokens</p>
              </div>
              <div className="text-center p-4 bg-neutral-700 rounded-lg">
                ...
                <p className="text-gray-400 text-sm">Ask questions and provide answers</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="account-setup" className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6">Account Setup</h2>
            ...
            <div className="bg-neutral-800 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-neutral-700 rounded-lg">
                  ...
                  <p className="text-gray-400 text-sm">Attach BBUX tokens to your question</p>
                </div>
                <div className="text-center p-4 bg-neutral-700 rounded-lg">
                  <FiMessageSquare className="w-8 h-8 text-violet-400 mx-auto mb-2" />
                  <h4 className="text-white font-semibold">Get Answers</h4>
                  <p className="text-gray-400 text-sm">Receive quality responses</p>
                </div>
                <div className="text-center p-4 bg-neutral-700 rounded-lg">
                  <FiStar className="w-8 h-8 text-violet-400 mx-auto mb-2" />
                  <h4 className="text-white font-semibold">Reward Winner</h4>
                  <p className="text-gray-400 text-sm">Automatically pay the best answer</p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-neutral-700 rounded-lg">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Basic platform access</p>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-neutral-700 rounded-lg">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Can create bounties, vote on answers</p>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-neutral-700 rounded-lg">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Moderation privileges, higher voting weight</p>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-neutral-700 rounded-lg">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Full platform privileges, governance participation</p>
                  </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-gray-400 text-sm">Complete platform overview and architecture</p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-gray-400 text-sm">Understanding the refund and governance system</p>
            </Link>
            <Link
              to="/docs/legal"
              className="block p-6 bg-neutral-800 rounded-lg border border-neutral-700 hover:border-violet-500/40 transition-all duration-300"
            >
              ...
              <p className="text-gray-400 text-sm">Terms of service and privacy policy</p>
            </Link>
            <Link
              to="/community"
              className="block p-6 bg-neutral-800 rounded-lg border border-neutral-700 hover:border-violet-500/40 transition-all duration-300"
            >
              ...
              <p className="text-gray-400 text-sm">Connect with other users and get help</p>
            </Link>
          </div>
        </section>
