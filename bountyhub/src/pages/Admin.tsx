        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-3xl font-bold text-gray-400">{stats.userCount}</p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg font-semibold mb-2">Moderators</h3>
              <p className="text-3xl font-bold text-blue-400">{stats.moderatorCount}</p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-lg font-semibold mb-2">Admins</h3>
              <p className="text-3xl font-bold text-red-400">{stats.adminCount}</p>
            </div>
          </div>
        )}
