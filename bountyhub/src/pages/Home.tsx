...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900 text-neutral-900 dark:text-white transition-colors duration-200 pt-16">
        {/* Hero Section */}
