...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm text-neutral-900 dark:text-white transition-colors duration-200 py-12 px-4 sm:px-6 lg:px-8">
