  ...
  return (
    <div className="min-h-screen bg-neutral-900">
      <div className="w-auto max-w-8xl mx-auto mt-4 px-4 ml-24 pb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {getCategoryDocs(category.name).map((doc: DocItem) => (
                  <Link
                    key={doc.href}
                    to={doc.href}
                    className="group block p-6 bg-neutral-800/60 rounded-lg border border-neutral-700 hover:border-violet-500/40 transition-all duration-300"
                  >
                    <div className="flex items-center mb-4">
                      <doc.icon className="w-6 h-6 text-violet-400 mr-3" />
        ...
        {/* Contact Section */}
        <div className="mt-20 p-8 bg-neutral-800/80 rounded-lg border-2 border-violet-500/30">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className="inline-flex items-center px-6 py-3 bg-neutral-700 text-white rounded-lg hover:bg-neutral-600 transition-colors"
              >
