        ...
        <div className="bg-neutral-800/80 rounded-lg p-6 border-2 border-violet-500/50 shadow-[0_0_15px_rgba(139,92,246,0.3)]">
          {posts.length > 0 ? (
            <div className="space-y-4">
              {posts.map((post) => (
                <div key={post.id} className={`p-4 bg-neutral-700/50 rounded-lg border border-violet-500/30 hover:bg-neutral-600/50 transition-colors ${post.reward && post.reward > 0 ? 'border-l-4 border-cyan-400/60 bg-gradient-to-r from-cyan-500/5 to-neutral-700/50' : ''}`}>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <h3 className="text-lg font-semibold text-violet-300">{post.title}</h3>
                        ...
                        <div className="flex items-center justify-between text-xs text-gray-400">
                          <div className="flex items-center gap-4">
                            ...
                            {post.editedAt && (
                              <span className="text-gray-500">(edited {new Date(post.editedAt).toLocaleDateString()})</span>
                            )}
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-500 mt-2">Start sharing your knowledge with the community</p>
              <Link 
                to="/posts/create" 
