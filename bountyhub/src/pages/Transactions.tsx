        ...
        <div className="max-w-4xl mx-auto">
          ...
          {transactions.length === 0 ? (
            <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-8 text-center">
              ...
              <p className="text-gray-500 mt-2">Your transaction history will appear here once you make your first transaction.</p>
            </div>
          ) : (
            <div className="space-y-6">
              {/* Transaction Cards */}
              {transactions.map((tx) => (
                <div key={tx.id} className="bg-neutral-800 border border-neutral-700 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="text-white font-mono text-xs break-all">{tx.id}</p>
                    </div>
                    {tx.metadata && (
                      <div className="md:col-span-2">
                        <p className="text-gray-400">Details</p>
                        <div className="bg-neutral-700 rounded p-3 mt-1">
