...
export function Footer() {
  return (
    <footer className="bg-white/70 dark:bg-neutral-800/70 backdrop-blur-sm border-t border-neutral-200/50 dark:border-neutral-700/50 py-6 transition-colors duration-200">
