...
import { FiCreditCard, FiLogOut, FiUsers, FiDollarSign, FiSettings, FiCheckSquare, FiRefreshCw } from 'react-icons/fi'
...
export function Nav() {
  ...
  return (
    <div className='group fixed left-0 top-0 h-screen w-20 bg-neutral-800 flex flex-col items-center transition-all duration-300 ease-in-out hover:w-64 overflow-y-hidden z-[9999] nav-container'>
      ...
      <div className="relative z-10 flex flex-col items-center w-full flex-1 justify-center">
        ...
        <Link to="/refund-requests" className="w-full py-3 flex justify-center items-center transition-all duration-300 group/item hover:bg-white/5">
          <div className="relative flex items-center justify-center gap-4 px-4 py-1 w-full">
            <FiRefreshCw className="h-6 w-6 text-gray-300 transition-all duration-300 group-hover:text-indigo-300 group-hover:scale-110" />
            {expanded && <span className="text-gray-300 text-sm font-medium transition-all duration-300 group-hover:text-indigo-300 whitespace-nowrap overflow-hidden max-w-xs">Refund Requests</span>}
          </div>
        </Link>
        <hr className='border-b border-gray-500 w-4/6 relative z-10'/>
        ...
        {user?.role === 'admin' && (
          <>
            <Link to="/admin" className="w-full py-3 flex justify-center items-center transition-all duration-300 group/item hover:bg-white/5">
              <div className="relative flex items-center justify-center gap-4 px-4 py-1 w-full">
                <svg className="w-6 h-6 text-gray-300 transition-all duration-300 group-hover:text-red-300 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
                {expanded && <span className="text-gray-300 text-sm font-medium transition-all duration-300 group-hover:text-red-300 whitespace-nowrap overflow-hidden max-w-xs">Admin Panel</span>}
              </div>
            </Link>
            <hr className='border-b border-gray-500 w-4/6 relative z-10'/>
          </>
        ...
        <div
          ...
          className="w-full py-3 flex justify-center items-center transition-all duration-300 group/item hover:bg-white/5 cursor-pointer relative"
          onClick={() => notificationsRef.current?.toggle()}
        >
          <div className="relative flex items-center justify-center gap-4 px-4 py-1 w-full">
            <svg className="w-6 h-6 text-gray-300 transition-all duration-300 group-hover:text-indigo-300 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
