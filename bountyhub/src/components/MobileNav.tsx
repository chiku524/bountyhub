...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white/70 dark:bg-neutral-800/70 backdrop-blur-sm border-t border-neutral-200/50 dark:border-neutral-700/50 md:hidden">
