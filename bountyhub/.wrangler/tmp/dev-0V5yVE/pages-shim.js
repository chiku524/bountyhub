...
var pages_shim_default = {
  async fetch(request, env3, context2) {
    const response = await env3.ASSETS.fetch(request.url, request);
...
// .wrangler/tmp/bundle-ekteco/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ekteco/middleware-loader.entry.ts
