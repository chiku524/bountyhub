...
export default function Privacy() {
  return (
    <div className="max-w-4xl mx-auto p-4 @sm/main:p-6">
        <div className="mb-6 flex flex-col gap-4 @sm/main:flex-row @sm/main:justify-between @sm/main:items-center">
          <h1 className="text-2xl @sm/main:text-3xl font-bold text-neutral-900 dark:text-white">Privacy Policy</h1>
        ...
        <div className="bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white rounded-lg shadow-lg p-4 @sm/main:p-8 print:shadow-none border border-neutral-200 dark:border-neutral-700">
            ...
            <div className="space-y-6 text-sm leading-relaxed">
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  <li>Email: privacy@bountyhub.tech</li>
